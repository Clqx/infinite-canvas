...
```txt
网页 -> http://127.0.0.1:17371/events（X-Canvas-Agent-Token header）
网页 -> http://127.0.0.1:17371/canvas/state（X-Canvas-Agent-Token header）
网页 -> http://127.0.0.1:17371/canvas/result（X-Canvas-Agent-Token header）
```
