...
```text
https://canvas.best/canvas?mode=new#agentUrl=<encoded Local URL>&agentToken=<encoded Connect token>
```
...
```text
<Vite Local 地址>/canvas?mode=new#agentUrl=<encoded Local URL>&agentToken=<encoded Connect token>
```
